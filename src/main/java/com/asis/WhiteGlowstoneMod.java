...
public class WhiteGlowstoneMod implements ModInitializer {
    ...
    //Blocks
    public static final Block WHITE_GLOWSTONE_BLOCK = new Block(FabricBlockSettings.copyOf(Blocks.GLOWSTONE));
    ...
    public void onInitialize() {
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "white_glowstone_block"), WHITE_GLOWSTONE_BLOCK);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "white_glowstone_block"), new BlockItem(WHITE_GLOWSTONE_BLOCK, new Item.Settings().group(MOD_ITEM_GROUP)));
